...
| Esp | yes | render **and** a full entity sweep |
...
genuinely ships instrumentation: `aspectjweaver-1.9.22.jar`, `byte-buddy-1.14.12.jar`, `byte-buddy-agent-1.14.12.jar`, `byte-buddy-dep-1.14.12.jar`, `h2-2.2.224.jar`, `javassist-3.30.2-GA.jar`, `mockito-core-5.11.0.jar`, `opentelemetry-javaagent-2.4.0.jar`, `pitest-1.16.1.jar`, `spring-context-6.1.6.jar`, `spring-instrument-6.1.6.jar`.
