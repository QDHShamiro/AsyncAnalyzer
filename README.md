...
and the [**benchmark page**](https://qdhshamiro.github.io/AsyncAnalyzer/) are generated by
`python3 ml/benchmark.py` and refreshed by CI on every push, so the numbers in this repo are
never hand-typed.
